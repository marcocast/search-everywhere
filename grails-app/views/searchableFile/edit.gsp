...
<html>
	...
	<body>
		<a href="#edit-searchableFile" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-searchableFile" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:searchableFileInstance, action:'update']" method="PUT" >
