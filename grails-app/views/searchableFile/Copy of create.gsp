...
<html>
	...
	<body>
		<a href="#create-searchableFile" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-searchableFile" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:searchableFileInstance, action:'save']" >
				<fieldset class="form">
