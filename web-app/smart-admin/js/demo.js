...
// hide bg options
var smartbgimage =
    "<h6 class='margin-top-10 semi-bold'>Background</h6><img src='smart-admin/img/pattern/graphy-xs.png' data-htmlbg-url='smart-admin/img/pattern/graphy.png' width='22' height='22' class='margin-right-5 bordered cursor-pointer'><img src='smart-admin/img/pattern/tileable_wood_texture-xs.png' width='22' height='22' data-htmlbg-url='smart-admin/img/pattern/tileable_wood_texture.png' class='margin-right-5 bordered cursor-pointer'><img src='smart-admin/img/pattern/sneaker_mesh_fabric-xs.png' width='22' height='22' data-htmlbg-url='smart-admin/img/pattern/sneaker_mesh_fabric.png' class='margin-right-5 bordered cursor-pointer'><img src='smart-admin/img/pattern/nistri-xs.png' data-htmlbg-url='smart-admin/img/pattern/nistri.png' width='22' height='22' class='margin-right-5 bordered cursor-pointer'><img src='smart-admin/img/pattern/paper-xs.png' data-htmlbg-url='smart-admin/img/pattern/paper.png' width='22' height='22' class='bordered cursor-pointer'>";
$("#smart-bgimages")
    .fadeOut();
